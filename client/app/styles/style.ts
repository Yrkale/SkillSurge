export const styles = {
    ...
    button: "flex flex-row justify-center items-center items-center py-3 py-3 rounded-full cursor-pointer bg-[#2190ff] min-h-[45px] w-full text-[16px] font-Poppins font-semibold",
}